...
$BODY$
begin
  RETURN QUERY select d.id, d.descid ,d.id_description_type, d.pattern, d.case_sensitive, d.autogenerated_name,  d.is_published,d.validity_until, d.id_concept,d.id_user,d.creation_date,d.is_modeled
