...
/**
 * Este es el objeto de negocio que representa la Descripción de un Concepto.
 *
...
public class Description extends PersistentEntity implements AuditableEntity {
     ...
     */
    public Description(long id, ConceptSMTK conceptSMTK, String descriptionID, DescriptionType descriptionType,
                       String term, long uses, boolean isCaseSensitive, boolean isAutoGenerated, boolean isPublished,
                       Timestamp validityUntil, Timestamp creationDate, User creatorUser, boolean isModeled) {
        super(id);
     ...
     * @param validityUntil   Fecha tope de vigencia.
     */
    public Description(ConceptSMTK conceptSMTK, String descriptionID, DescriptionType descriptionType, String term,
                       boolean isCaseSensitive, boolean isAutoGenerated, boolean isPublished, Timestamp
                               validityUntil, Timestamp creationDate, User creatorUser, boolean isModeled) {
        this(DAO.NON_PERSISTED_ID, conceptSMTK, descriptionID, descriptionType, term, 0, isCaseSensitive,
                isAutoGenerated, isPublished, validityUntil, creationDate, creatorUser, isModeled);
    }
    ...
    public Description(ConceptSMTK conceptSMTK, String term, DescriptionType descriptionType) {
        this(-1, conceptSMTK, "NULL", descriptionType, term, 0, false, false, false, null, new Timestamp
                (currentTimeMillis()), User.getDummyUser(), false);
    }
    ...
    public String fullToString() {
        return this.term + "[ID=" + this.getId() + ", DESCRIPTION_ID=" + this.descriptionID + " Type=" + this
                .descriptionType + "]";
    }
}
