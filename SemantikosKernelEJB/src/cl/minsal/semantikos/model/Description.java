...
public class Description extends PersistentEntity implements AuditableEntity {
     ...
     */
    public Description(long id, ConceptSMTK conceptSMTK, String descriptionID, DescriptionType descriptionType, String term, int uses, boolean isCaseSensitive, boolean isAutoGenerated, boolean isPublished, Timestamp validityUntil, Timestamp creationDate, User creatorUser, boolean isModeled) {
        super(id);
