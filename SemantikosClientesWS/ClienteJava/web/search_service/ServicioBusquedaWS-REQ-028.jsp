...
<html>
<header>
    <title>Semantikos - WS-REQ-028: Obtener Concepto por ID Descripción</title>
...
<div class="container">
    <h4>Semantikos - WS-REQ-028: Obtener Concepto por ID Descripción</h4>

    <form method="post" action="<%=request.getContextPath()%>/ws-req-028">
        ...
        <c:if test="${requestScope.serviceResponse != null}">
            <div id="Response">
                <jsp:useBean id="stringer" class="cl.minsal.semantikos.ws.shared.Stringer"
                    ...
                    <%= HTMLer.toHTML((Concepto) request.getAttribute("serviceResponse")) %>
                    <br/>
                </jsp:useBean>
            </div>
        </c:if>
