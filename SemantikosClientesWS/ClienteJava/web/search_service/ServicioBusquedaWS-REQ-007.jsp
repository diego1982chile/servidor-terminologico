...
<html>
<header>
    <title>Semantikos - WS-REQ-007: Obtener REFSET por ID Descripción</title>
...
<div class="container">
    <h4>Semantikos - WS-REQ-007: Obtener REFSET por ID Descripción</h4>

    <form method="post" action="<%=request.getContextPath()%>/ws-req-007">

        <!-- El término a buscar -->
        <div class="form-group">
            <label for="description_ID">DESCRIPTION ID</label>
            <input type="text" id="description_ID" name="description_ID" class="form-control" placeholder="Ingrese el DESCRIPTION ID" required="required">
        </div>
