...
<html>
<header>
    <title>Semantikos - WS-REQ-022: Obtener Miembros Preferidos de un REFSET</title>
...
<div class="container">
    <h4>Semantikos - WS-REQ-022: Obtener Miembros Preferidos de un REFSET</h4>

    <form method="post" action="<%=request.getContextPath()%>/ws-req-022">
