 ...
 */
@WebServlet(urlPatterns = "/ws-req-023")
public class WebServiceReq023Servlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(WebServiceReq023Servlet.class);

    /**
     * La pagina JSP de destino para este servlet
     */
    private String targetPage = "/search_service/ServicioBusquedaWS-REQ-023.jsp";
     ...
     */
    public WebServiceReq023Servlet() {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        logger.debug(this.getClass().getName() + ".doPost(): Params: " + Stringer.toString(peticion));
