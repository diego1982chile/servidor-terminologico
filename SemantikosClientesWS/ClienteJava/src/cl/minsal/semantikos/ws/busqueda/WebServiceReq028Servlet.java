 ...
 */
@WebServlet(urlPatterns = "/ws-req-028")
public class WebServiceReq028Servlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(WebServiceReq028Servlet.class);

    /**
     * La pagina JSP de destino para este servlet
     */
    private String targetPage = "/search_service/ServicioBusquedaWS-REQ-028.jsp";
     ...
     */
    public WebServiceReq028Servlet() {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Concepto response;
        try {
            response = this.servicioDeBusqueda.getSearchServicePort().conceptoPorIdDescripcion(description_id);
