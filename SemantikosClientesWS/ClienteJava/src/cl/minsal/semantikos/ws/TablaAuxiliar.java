...
public class TablaAuxiliar {
    ...
    public static class ColumnaTablaAuxiliar {
        ...
        protected List<cl.minsal.semantikos.ws.ColumnaTablaAuxiliar> columna;
         ...
         * {@link cl.minsal.semantikos.ws.ColumnaTablaAuxiliar }
         * 
         * 
         */
        public List<cl.minsal.semantikos.ws.ColumnaTablaAuxiliar> getColumna() {
            if (columna == null) {
                columna = new ArrayList<cl.minsal.semantikos.ws.ColumnaTablaAuxiliar>();
            }
            return this.columna;
        }
